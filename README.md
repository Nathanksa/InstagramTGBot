...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/techcrazebk/InstagramTGBot)
...
1. Clone the repo
   ```markdown
   git clone https://github.com/techcrazebk/InstagramTGBot
   ```
